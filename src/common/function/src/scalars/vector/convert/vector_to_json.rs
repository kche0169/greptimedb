...
const NAME: &str = "vec_to_json";

#[derive(Debug, Clone, Default)]
pub struct VectorToJsonFunction;

impl Function for VectorToJsonFunction {
    fn name(&self) -> &str {
        NAME
    }
...
impl Display for VectorToJsonFunction {
